...
$livemesh_shortcodes['icon'] = array(
    ...
    'params' => array(
        ...
        'class' => array(
            ...
            'desc' => esc_html__('Custom CSS class name to be set for the icon element created. The class names are listed at https://www.livemeshthemes.com/support/faqs/how-to-use-1500-icons-bundled-with-the-agile-theme/', 'peak')
        ),
        'style' => array(
            'std' => '',
            'type' => 'text',
    ...
    'child_shortcode' => array(
        'params' => array(
            ...
            'icon' => array(
                ...
                'desc' => esc_html__('The font icon to be displayed for the statistic being displayed. The class names are listed at https://www.livemeshthemes.com/support/faqs/how-to-use-1500-icons-bundled-with-the-agile-theme/', 'peak'),
            )
        ),
