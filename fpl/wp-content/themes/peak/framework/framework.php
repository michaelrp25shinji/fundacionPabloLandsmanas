...
class MO_Framework {
    ...
    function enqueue_scripts() {
        ...
        if (!is_admin()) {
            ...
            wp_enqueue_script('mo-jquery-plugins-lib', MO_SCRIPTS_LIB_URL . '/jquery.plugins.lib.js', array('jquery'), '1.0', true);
            ...
            /* Slider packs */
            wp_enqueue_script('mo-jquery-flexslider', MO_SCRIPTS_LIB_URL . '/jquery.flexslider.js', array('jquery'), '1.2', true);
            wp_enqueue_script('mo-jquery-owl-carousel', MO_SCRIPTS_LIB_URL . '/owl.carousel.min.js', array('jquery'), '4.1', true);
    ...
    function enqueue_styles() {
        ...
        wp_register_style('mo-style-theme', get_template_directory_uri() . '/style.css', array(
            'mo-icon-fonts'
        ), false, 'all');
