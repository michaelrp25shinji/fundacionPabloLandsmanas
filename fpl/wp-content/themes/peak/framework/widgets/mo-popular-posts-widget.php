...
class MO_Popular_Posts_Widget extends WP_Widget {
    ...
    public function __construct() {
        ...
        /* Widget settings. */
        $widget_ops = array('classname' => 'popular-posts-widget', 'description' => esc_html__('A widget that displays the most popular posts.', 'peak'));

        /* Widget control settings. */
        $control_ops = array('width' => 300, 'height' => 350, 'id_base' => 'mo-popular-posts-widget');

        /* Create the widget. */
        parent::__construct('mo-popular-posts-widget', esc_html__('Popular Posts Widget', 'peak'), $widget_ops, $control_ops);
    }
    ...
    function form($instance) {
        ...
        $defaults = array('title' => esc_html__('Most Popular Posts', 'peak'), 'post_count' => '5', 'excerpt_count' => '100', 'hide_thumbnail' => false, 'show_meta' => false);
