...
class MO_Related_Posts_Widget extends WP_Widget {
    ...
    public function __construct() {
        ...
        /* Widget settings. */
        $widget_ops = array('classname' => 'related-posts-widget', 'description' => esc_html__('A widget that displays the related posts with thumbnails.', 'peak'));

        /* Widget control settings. */
        $control_ops = array('width' => 300, 'height' => 350, 'id_base' => 'mo-related-posts-widget');

        /* Create the widget. */
        parent::__construct('mo-related-posts-widget', esc_html__('Related Posts Widget', 'peak'), $widget_ops, $control_ops);
    }
    ...
    function form($instance) {
        ...
        $defaults = array('title' => esc_html__('Related Posts', 'peak'), 'post_count' => '5', 'excerpt_count' => '100', 'hide_thumbnail' => false, 'show_meta' => false, 'match_taxonomy' => 'category');
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('match_taxonomy')); ?>"><?php esc_html_e('Match:', 'peak'); ?></label>
            <select class="widefat" id="<?php echo esc_attr($this->get_field_id('match_taxonomy')); ?>" name="<?php echo esc_attr($this->get_field_name('match_taxonomy')); ?>">
