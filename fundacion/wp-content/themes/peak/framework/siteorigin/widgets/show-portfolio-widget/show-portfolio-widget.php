        ...
        parent::__construct(
            ...
            array(
                ...
                "number_of_columns" => array(
                    "type" => "slider",
                    "description" => __("For Fit Rows - Number of portfolio items to display per row.<br> For Masonry - default number of columns occupied by a single portfolio item in a row of 12 column grid. This value can be altered for each portfolio item in the portfolio edit window.", "wired_theme"),
                    "label" => __("Number of columns", "wired_theme"),
                    "min" => 1,
                    "max" => 5,
                    "integer" => true,
                    "default" => 4,
