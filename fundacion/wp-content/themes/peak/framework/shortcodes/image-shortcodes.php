...
Usage: See examples at https://www.livemeshthemes.com/peak/image-shortcodes/
...
/* Shortcode for photo grid to help arrange images in a neat grid. */
function mo_photo_grid_shortcode($atts, $content = null, $shortcode_name = "") {
    ...
    return '<div' . $id . ' data-layout="'. $layout .'" class="photo-grid '. $class . '" style="visibility: hidden;">' . do_shortcode(mo_remove_wpautop($content)) . '</div>';
}

add_shortcode('photo_grid', 'mo_photo_grid_shortcode');
